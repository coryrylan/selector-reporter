  ...
  var c = [],
    ...
    var b,
      ...
      (function () {
        ...
        f.style.backgroundClip = "content-box", f.cloneNode(!0).style.backgroundClip = "", k.clearCloneStyle = "content-box" === f.style.backgroundClip, e.style.cssText = "border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute", e.appendChild(f);a.getComputedStyle && n.extend(k, { pixelPosition: function () {
            return (g(), b);
...
(function () {
    ...
    selectorReporter.run({
        ...
        messages: [{ selector: ".defaultButton", message: "is deprecated please use .btn", level: "warning" }, { selector: ".col_6" }]
    });
})();